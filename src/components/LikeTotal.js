...
const LikeTotal = (props) => {
    ...
    return (
        <div>
            ...
            <div className='counter-container'>
                <button className='decrement-button' onClick={() => props.setTotalLikes3(Math.max(0, props.totalLikes3 - 3))}>
                    -
                </button>
                <p className='total-likes'>{props.totalLikes3}</p>
                <button className='increment-button' onClick={() => props.setTotalLikes3(props.totalLikes3 + 3)}>
                    +
                </button>
            </div>
        </div>
